...
document.getElementById("jDois").innerHTML = jogador1;
document.getElementById("pontuacaoJUm").innerHTML = jogador1;
document.getElementById("pontuacaoJDois").innerHTML = jogador1;
function enviar(){
